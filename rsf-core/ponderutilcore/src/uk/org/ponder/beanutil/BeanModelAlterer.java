...
public interface BeanModelAlterer {
   ...
   * {@link #fetchShells(String, Object, boolean)} -  the section of the path
  ...
  /** 
   * Invoke a bean method from a path in the model. 
   * @param methodEL method to invoke
   * @param rootobj object to invoke method on
   * @return Object
   */
  ...
  /** 
   * @see #applyAlterations(Object, DARList, DAREnvironment)
   * @param rootobj the root on
   * @param dar the DAR list
   * @param darenv the DAR environment
   */
   ...
   * 
   * @param fullpath the EL path
   * @param rootobj the root object
   * @param expectMethod to stop at a DARApplier
   * @return the shell
   */
